...
export const BASE_IMAGE_PATHS = [
    ...
    "/assets/images/landing/cards/12.jpg",
];
...
export const SCROLL_EASE = [0.16, 0.9, 0.24, 1];
export const SCROLL_MOTION_DURATION = 0.34;
export const BG_MOTION_DURATION = 0.48;
export const MOTION_TARGET_EPSILON = 0.0002;
export const CARD_REVEAL_DURATION = 2.8;
export const CARD_REVEAL_EASE = [0.12, 0.86, 0.18, 1];
export const CARD_REVEAL_ROTATION = -PHASE_PER_SECTION * 0.42;
export const CARD_REVEAL_STAGGER = 0.014;
export const CARD_REVEAL_WINDOW = 0.86;
